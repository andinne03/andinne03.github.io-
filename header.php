...
<html lang="en">
    ...
    <style>
        ...
        #header {
            ...
            background: linear-gradient(to right, #ec6f16, #ffb25f, #efdd6f); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
			...
			<div id="top-header">
				<div class="container">
					<ul class="header-links pull-left">
						<li><a href="#"></i> Andinne Tiara</a></li>
						<li><a href="#"></i>21537141019</a></li>
					</ul>
                               ...
                               <div class="dropdownn">
                                ...
                                <div class="dropdownn">
								  ...
								  <div class="dropdownn-content">
									...
									<a href="bot.php"><i class="fa fa-comment" aria-hidden="true"></i>Chatbot</a>
					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="header-logo">
								<a href="#" class="logo">
								<font style="font-style:bold; font-size: 33px;color: aliceblue;font-family: serif">
                                        Online Shop
                                    </font>
